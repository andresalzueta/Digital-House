...
class GenreController extends Controller
{
    ...
    public function new() {
        ...
        $msgbotao = "Inserir->";
        $sucesso = null;
        $action="/Digital-House/Laravel/public/genre/add";
    ...
    public function create(Request $request) {
        ...
        if ($result) {
            ...
            $action="/Digital-House/Laravel/public/genre/update/$genero->id";
            $sucesso=true;
        } else {
    ...
    public function read($id) {
        ...
        $msgbotao = "Retornar ->";
        $action="/Digital-House/Laravel/public/genres";
        $sucesso = null;
    ...
    public function preDelete($id) {
        ...
        $msgbotao = "Deletar->";
        $sucesso=null;
        $action="/Digital-House/Laravel/public/genre/delete/$genero->id";
