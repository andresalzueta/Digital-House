        ...
        <form class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="editarFilme" name="editarFilme" method="POST" action="{{$action}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-9 col-md-9 col-sm-9 col-xs-1">
                    ...
                    <input type="text" class="form-control" name="title" id="title" value="{{ $filme->title }}" placeholder="Insira título do filme"/>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-3">
                    <label for="awards">Prêmios</label>
                    <input type="number" class="form-control" id="awards" name="awards" step="1" min="0" max="99" value="{{ $filme->awards }}" placeholder="Insira awards"/>
                </div>
                <div class="form-group col-sm-3">
                    <label for="rating">Classificação</label>
                    <input type="number" class="form-control" id="rating" name="rating" step="0.1" value="{{ $filme->rating }}" placeholder="Insira rating"/>
                </div>
                <div class="form-group col-sm-3">
                    <label for="length">Duração do filme</label>
                    <input type="number" class="form-control" id="length" name="length" step="1" min="10" max="999" value="{{ $filme->length }}" placeholder="Defina tamanho do filme">
                </div>
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    <input type="number" class="form-control" id="revenue" name="revenue" step="1" min="0" max="99999999" value="{{ $filme->revenue }}" placeholder="Insira bilheteria"/>
                </div>
                <div class="form-group col-sm-3">
                    <label for="genre_id">Data de estreia</label>
                    <input type="date" class="form-control" id="release_date" name="release_date" min="1900-01-01" value="{{ $filme->getReleaseDateToInput() }}" placeholder="Insira Data de Lançamento">
                </div>
                <div class="form-group col-sm-3">
