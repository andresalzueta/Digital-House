            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <!-- Dropdown -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="http://localhost:8080/Digital-House/Laravel/public/users" id="navbardrop" data-toggle="dropdown">
                            Usuários
                            </a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="http://localhost:8080/Digital-House/Laravel/public/users">Exibir Usuários</a>
                                <a class="dropdown-item" href="http://localhost:8080/Digital-House/Laravel/public/user/new">Inserir Usuário</a>
                            </div>
                        </li>
