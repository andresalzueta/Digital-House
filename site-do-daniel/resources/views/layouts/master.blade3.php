...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
    <nav class="navbar navbar-default crypto-header col-12  col-xs-12 col-sm-12 col-md-12 col-lg-12" >        
        <div class="container">
            <div id="navbar-header">
                ...
                <div class="logo col-12  col-xs-12 col-sm-12 col-md-2 col-lg-2">
                        <img src="{{url('img/logo/ex3tr')}}.png" width="170" style="
                        margin-left: 10px;">
                    </div>
                    ...
                    <nav class="navbar navbar-expand-md col-sm-12 col-md-12 col-lg-12">
